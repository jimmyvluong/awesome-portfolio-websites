...
const exp = [
  ...
  },
  {
    ...
    desp: "<li><a href='https://corise.com/course/sql-crash-course'>Corise website</a></li><li>Host office hour sessions to support student learning.</li><li>Answer student questions about SQL based on industry best-practice.</li>",
  },
  {
  ...
  },
  {
    ...
    time: "(September 2021 - present)",
    desp: "<li><a href='https://www.sfc.ac.uk/'>Scottish Funding Council website</a></li><li>Analyze 15+ years of Scottish college and university student information using SQL, Python (Pandas), & SAS.</li><li>Spearheaded creation of QlikView dashboards for 40 colleges and universities for use by CEO and directors</li>",
  },
  {
    ...
    time: "(September 2021 - present)",
    desp: "<li><a href='https://www.ranacohabitat.com/'>Rana Creek website</a></li><li>Responsible for overall program management of consulting portfolio of 10+ active projects valued >$1.5M.</li><li> Led and trained team of 12+ including project engineers, foremen, and admin staff.</li>",
  },
];
